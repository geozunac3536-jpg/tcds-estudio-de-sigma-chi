...
Cada enlace en el sitio incluye su `data-sha256` para trazabilidad con Σ-metrics y GA4.<!doctype html>
<html lang="es">
<head>
  <meta charset="utf-8">
...
<body>
  <h1>TCDS Σ–χ — Integración GA4</h1>
  <p>Panel de prueba para verificar la instrumentación GA4 de Σ-metrics.  
  Usa estos botones y observa los eventos en <strong>DebugView</strong> de Google Analytics 4.</p>

  <section>
    <h2>📥 Prueba de Descarga (sigma_download)</h2>
  ...
  <section>
    <h2>🔄 Estado de Coherencia (sigma_lock)</h2>
    <button onclick="trackSigmaLock(0.92,0.96,0.08,334,5.2)">Enviar Locking LI=0.92</button>
  </section>

  <section>
    <h2>🌎 Predicción Σ-Earth</h2>
    <button onclick="trackPredictionPublished('2025-11-02','Mesoamérica',5.5,'hash123abc')">Publicar Predicción</button>
  ...
  <section>
    <h2>📊 Documentos y Definiciones</h2>
    <p>Consulta los siguientes archivos para implementación completa:</p>
    <ul>
